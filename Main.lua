...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Max Interface Suite",
   LoadingSubtitle = "by Max",
   ShowText = "Max", -- for mobile users to unhide rayfield, change if you'd like
   ...
   Discord = {
      ...
      Invite = "RksBv89HR5", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
   ...
   KeySettings = {
      ...
      FileName = "Max", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = false, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"Was-Das"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})

Rayfield:Notify({
   Title = "Silus",
   Content = "Subscribe to @Max !",
   Duration = 6.5,
   Image = 4483362458,
})
